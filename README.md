...
$N=10^4$ points generated from $Y = f(X) + \xi$, $\xi \sim N(0,1)$ and $X \in \mathbb R^2$. We observe dataset $(Z,Y)$, where $Z = (W,X)$, $W \in \bb R^{9998} and try to learn prediction surface $(w,x) \mapsto f(x)$. 
