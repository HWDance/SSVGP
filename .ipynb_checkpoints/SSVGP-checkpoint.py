...
class train:
    ...
    def kernel_param_optimise(y,X,l0=None,s0=1,sig0=1,v=1e+4,c=1e-8,lmbda=1,reg=1e-3,kern=kernel_funcs.gaussian,grad_kern=kernel_funcs.grad_gaussian,minibatch=None,sampling_strat="nn",nn_fraction=1,
    ...
    def aCAVI(y,X,l0=0.1,s0=1,sig0=1,lmbda0=1,logpi0=0,log1_pi0=0,v=1e+4,c=1e-8,a=1e-3,b=1e-3,reg=1e-2,aCAVI_iter=10,
                            init_grad_step=200,grad_step=100,minibatch=None,sampling_strat = "nn", nn_fraction = 1,
                            ...
                            timer=False,store_elbo=False,kern=kernel_funcs.gaussian,grad_kern = kernel_funcs.grad_gaussian, store_ls = False, 
                             seed = None,prune = True, final_prune = False, prune_PIP=0.5, learn_scale = False, optimisation_sums = []):
        """
